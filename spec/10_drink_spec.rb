...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_milkshake) { described_class.new('milkshake') }

      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_milkshake.type).to eql('milkshake')
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(my_milkshake.ounces).to eql(16)
      end
    end
  end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      ...
      # remove the 'x' before running this test
      it 'is full' do
        expect(my_milkshake).to be_full
      end
    end
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_milkshake) { described_class.new('milkshake', 15) }

      # remove the 'x' before running this test
      it 'is not full' do
        expect(my_milkshake).not_to be_full
      end
    end
  end
end
